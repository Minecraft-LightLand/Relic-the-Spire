...
public abstract class BlockRelicItem extends BlockItem implements ICurioItem, IBaseRelicItem {

	@Nullable
	private final TokenRelicComponent<?> token;

	public BlockRelicItem(Block block, Properties prop) {
		this(block, prop, null);
	}

	public BlockRelicItem(Block block, Properties prop, @Nullable TokenRelicComponent<?> token) {
